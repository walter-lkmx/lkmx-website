      ...
      <Page className={styles.index}>
        ...
        <Column className={styles.index__second} number="2" mode="full">
          ...
          <div className={styles.index__second__block__right}>
              <img src="/circle--pink.svg" className={styles.index__second__block__right__circle}/>
              <img src="/dragon.svg" className={styles.index__second__block__right__dragon}/>
            </div>
          </Block>
        </Column>
        ...
        <Column className={styles.index__partners}>
          <Block className={styles.index__partners__block}>
            <img className={styles.index__partners__block__leftTriangle} src="/triangles/triangle-waves--left.svg"/>
